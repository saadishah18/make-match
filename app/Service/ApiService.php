...
//        return $this->response(config('app.debug') ? $throwable->getTrace() : null, config('app.debug') ? $throwable->getMessage() : trans('response.server_error'), 500);
        return $this->response( null, config('app.debug') ? $throwable->getMessage() : trans('response.server_error'), 500);
    }
