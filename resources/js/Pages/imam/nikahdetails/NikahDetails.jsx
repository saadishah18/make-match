...
export default function NikahDetails(props) {
    ...
    return (
        ...
        >
            <Head title="Imam Nikah Detail" />
            {
                loader ? <LoadingCircle loading={loader}/> : (
                    <>
                        <div className="mb-6 block md:flex items-center w-full">
                            <Link className="flex items-center justify-center text-black text-sm font-productsans-bold gap-5 mr-5" href={route('imam.nikahmanagement')} as="button">
                        ...
                        <div className="w-full bg-white p-10 rounded-2xl">
                            ...
                            <h3 className="text-xl mb-5 font-medium">Other Information</h3>
                            <ul className="flex flex-wrap items-center mb-5 border-b border-b-black">
                                <li className="w-1/2 mb-3">
                                    <strong className="block font-medium">Groom ID #</strong>
                                    <span className="block">{nikah?.groom_detail.id_card_number}</span>
                                </li>
                                <li className="w-1/2 mb-3">
                                    <strong className="block font-medium">Groom ID Front</strong>
                                    <span className="block">
                                      <img className="block" width="200px" src={nikah.groom_detail.id_card_front} onClick={openCertificateModal} />
                                    </span>
                                </li>
                                <li className="w-1/2 mb-3">
                                    <strong className="block font-medium">Groom ID Back</strong>
                                    <span className="block">
                                      <img className="block" width="200px" src={nikah.groom_detail.id_card_back} onClick={openCertificateModal} />
                                    </span>
                                </li>

                                <li className="w-1/2 mb-3">
                                    <strong className="block font-medium">Groom Selfie</strong>
                                    <span className="block">
                                      <img className="block" width="200px" src={nikah.groom_detail.selfie} onClick={openCertificateModal} />
                                    </span>
                                </li>

                                <li className="w-1/2 mb-3">
                                    <strong className="block font-medium">Bride ID #</strong>
                                    <span className="block">{nikah?.bride_detail.id_card_number}</span>
                                </li>

                                <li className="w-1/2 mb-3">
                                    <strong className="block font-medium">Bride ID Front</strong>
                                    <span className="block">
                                      <img className="block" width="200px" src={nikah.bride_detail.id_card_front} onClick={openCertificateModal} />
                                    </span>
                                </li>
                                <li className="w-1/2 mb-3">
                                    <strong className="block font-medium">Bride ID Back</strong>
                                    <span className="block">
                                      <img className="block" width="200px" src={nikah.bride_detail.id_card_back} onClick={openCertificateModal} />
                                    </span>
                                </li>

                                <li className="w-1/2 mb-3">
                                    <strong className="block font-medium">Bride Selfie</strong>
                                    <span className="block">
                                      <img className="block"width="200px" src={nikah.bride_detail.selfie} onClick={openCertificateModal} />
                                    </span>
                                </li>
                            </ul>
                            ...
                            {/*<Certificate isOpen={showCertificate} closeModal={closeCertificateModal} nikah_detail={nikah}/>*/}
