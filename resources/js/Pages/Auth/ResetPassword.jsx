  ...
  /*  useEffect(() => {
    ...
    return (
        <AuthLayout>
            ...
            <div className="at-loginpage w-full h-full  flex justify-center items-center">
                <div className="at-authformholder flex items-center justify-center flex-col bg-white relative h-full w-full max-w-[600px] xl:min-h-[969px] p-[30px] mx-auto">
                    ...
                    <form className="w-full" onSubmit={submit}>
                        ...
                        <div className="mt-4 at-forminputs relative">
                            <TextInput type={isVisible ? 'text' : 'password'} name="password" value={data.password}
                                       className="mt-1 block w-full" autoComplete="new-password"
