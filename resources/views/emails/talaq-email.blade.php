                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h1 style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">
                                        Dear {{ucfirst($partner->first_name)}} {{ucfirst($partner->last_name)}}</h1>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        ...
                                        husband {{ucfirst($user->first_name)}} {{ucfirst($user->last_name)}} has issued
                                        a Talaq.
                                        As per our records, the Talaq counter is {{$talaq->talaq_counter}} and the
                                        Talaq date is
                                        @php
                                        $talaq_date = '';
                                            if ($talaq->talaq_counter == 1 && $talaq->{'1st_talaq_date'} != null && $talaq->{'2nd_talaq_date'} == null && $talaq->{'3rd_talaq_date'} == null) {
                                                $talaq_date = $talaq->{'1st_talaq_date'};

                                            } elseif ($talaq->talaq_counter == 2 && $talaq->{'2nd_talaq_date'} != null && $talaq->{'3rd_talaq_date'} == null) {
                                               $talaq_date = $talaq->{'2nd_talaq_date'};
                                            } elseif($talaq->talaq_counter == 3 && $talaq->{'3rd_talaq_date'} != null ) {
                                                $talaq_date = $talaq->{'3rd_talaq_date'};
                                            }
//                                        @endphp
                                        {{\Carbon\Carbon::parse($talaq_date)->toFormattedDateString()}}.
                                        We understand that this is a sensitive matter, and we are here to support you
                                        during this challenging time.

                                        Please feel free to reach out to us for any assistance or guidance you may need.
