                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100vw; padding: 32px;">
                                    <h1 style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">Assalaamu Alaykum</h1>
                                    <p>Good News!</p>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        <b>{{ucfirst($login_user->first_name)}} {{ucfirst($login_user->last_name)}}</b> wants to connect with you on the MyNikahNow App.</p>

                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        To link with <b> {{ucfirst($login_user->first_name)}} {{ucfirst($login_user->last_name)}}</b>, please follow these simple steps:</p>

                                    <ol>
                                        <li>Download the MyNikahNow App from your preferred App Store.</li>
                                        <li>
                                            Register a new account (it's free) and complete your profile.
                                        </li>
                                    </ol>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">

                                    Link with {{ucfirst($login_user->first_name)}} {{ucfirst($login_user->last_name)}} by pressing the "Link Your Partner" button and using the following 8-digit code:</p>
                                    <p><b>{{$login_user->qr_number}}</b></p>

                                <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                    If you have any questions or need assistance, feel free to contact the MyNikahNow Team by using the in-app chat.</p>
                                <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                    Kind Regards,<br>
                                    MyNikahNow Team <br>

                                </p>
                                    <a href="www.mynikah.app">www.mynikah.app</a>
